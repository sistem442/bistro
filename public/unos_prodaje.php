    ...
    <?php
			...
			while ($obj=mysqli_fetch_object($result)){
				...
				<div class='input_wrapper'>
					<div style='width:200px; float:left; id='".$id_artikla."''>".$obj->ime."</div>
				    <div><input type='number' name='".$id_artikla."' value=0 /></div>
				</div>
				";
            ...
            <div style='height:50px'><input type="number" name="prezentacija" value="0"/></div>
            <div style='width:200px; float:left; height:50px;'>prezentacija za klub</div>
            <div style='height:50px'><input type="number" name="prezentacija_klub" value="0"/></div>
            <?php $mysqli->close();
            ?>
    <input type="submit" name="submit" value="Upiši u bazu" />
  </form>
